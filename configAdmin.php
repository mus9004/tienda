    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Camacho Comercial</small></h1>
            </div>
            <!-- Nav tabs -->
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>RTN</label>
                                    <input class="form-control" type="text" name="prove-nit" placeholder="RTN proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
                                ...
                                <div class="form-group">
                                    <label>Correo</label>
                                    <input class="form-control" type="email" name="prove-cor" placeholder="Correo electronico" required="" maxlength="50" data-toggle="tooltip" pattern="^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$">
                                </div>
